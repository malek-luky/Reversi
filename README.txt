This repository is one of the many assignments from the course 'Cybernetics and Artificial Intelligence' at CTU. Our task was to create an algorithm in player.py for the game Reversi/Othello. Then we compete in the tournament with each other. I was 4th in the Czech class and won against the English speaking students.
