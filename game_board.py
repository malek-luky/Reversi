...
class GameBoard(object):
    ...
    def init_board(self):
        ...
        board[half_board - 1][half_board - 1] = self.p2_color
        board[half_board][half_board] = self.p2_color
        board[half_board][half_board - 1] = self.p1_color
        board[half_board-1][half_board] = self.p1_color
        return board
